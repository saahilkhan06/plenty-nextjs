...
export default function Headnavtest() {
  ...
  return (
    <div className="bg-white text-black">
        ...
        <div className="mx-auto flex max-w-[1400px] items-center justify-between gap-2 px-3 py-2 sm:gap-4 sm:px-5 sm:py-3 lg:gap-6 lg:py-4">
          ...
          <div className="flex min-w-0 items-center gap-3 sm:gap-4 lg:gap-8">
            ...
            <div className="flex shrink-0 items-center gap-2">
              ...
              <span className="hidden flex-col text-[13px] leading-tight lg:flex">
            ...
            >
              ...
              <span className="ml-2 hidden flex-col text-left lg:flex">
                ...
                <small className="text-[13px] font-medium">
                  Everyday{" "}
                  <span className="text-lg font-bold">8 am</span>{" "}
                  to{" "}
      ...
      <section className="w-full bg-blue-950 bg-cover bg-center px-5 py-4 text-white sm:px-8 lg:py-8">
            ...
            <div className="flex w-full gap-4">
              ...
              <div className="flex-1 lg:hidden">
                <VoiceSearch
                  onTextReceived={(text) => {
                    console.log(
                      "🎤 Voice text received in Headnavtest:",
                      text
                    );
